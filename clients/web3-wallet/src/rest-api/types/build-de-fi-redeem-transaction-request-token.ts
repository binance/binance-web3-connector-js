 ...
 * @export
 * @interface BuildDeFiRedeemTransactionRequestToken
 */
export interface BuildDeFiRedeemTransactionRequestToken {
    /**
     * Token contract address; the native-asset sentinel for the native coin.
     * @type {string}
     * @memberof BuildDeFiRedeemTransactionRequestToken
     */
    tokenAddress: string;
    /**
