 ...
 * @export
 * @interface BuildDeFiDepositTransactionRequestToken
 */
export interface BuildDeFiDepositTransactionRequestToken {
    /**
     * Token contract address; the native-asset sentinel for the native coin.
     * @type {string}
     * @memberof BuildDeFiDepositTransactionRequestToken
     */
    tokenAddress: string;
    /**
