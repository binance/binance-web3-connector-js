 ...
 * @export
 * @interface BuildLpAddTransactionRequestTokenListInner
 */
export interface BuildLpAddTransactionRequestTokenListInner {
    /**
     * Token contract address; the native-asset sentinel for the native coin.
     * @type {string}
     * @memberof BuildLpAddTransactionRequestTokenListInner
     */
    tokenAddress: string;
    /**
