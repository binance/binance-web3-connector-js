    ...
    describe('getAggregatedQuote()', () => {
        ...
        it('should execute getAggregatedQuote() successfully with optional parameters', async () => {
            const params: GetAggregatedQuoteRequest = {
                ...
                recvWindow: 5000,
                nonce: 'unique-nonce-string',
                vendor: GetAggregatedQuoteVendorEnum.LiquidMesh,
                userWalletAddress: '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045',
                feePercent: '1.5',
    ...
    describe('quoteAndBuildSwapTransaction()', () => {
        ...
        it('should execute quoteAndBuildSwapTransaction() successfully with optional parameters', async () => {
            const params: QuoteAndBuildSwapTransactionRequest = {
                ...
                nonce: 'unique-nonce-string',
                slippagePercent: '0.5',
                excludeDexes: 'Pancakeswap V4,Pancakeswap V3',
                enableRFQ: QuoteAndBuildSwapTransactionEnableRFQEnum.TRUE,
